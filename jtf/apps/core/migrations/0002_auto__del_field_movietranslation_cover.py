...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MovieTranslation.cover'
        db.delete_column(u'core_movie_translation', 'cover_id')


    def backwards(self, orm):
        # Adding field 'MovieTranslation.cover'
        db.add_column(u'core_movie_translation', 'cover',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='movie', null=True, to=orm['core.Image']),
                      keep_default=False)
